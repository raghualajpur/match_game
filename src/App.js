...
class App extends Component {
  ...
  updateDisplayMisMatch = () => {
    this.setState(prevState => ({
      displayForWrongMatch: !prevState.displayForWrongMatch,
    }))
  }

  render() {
    const {time, score, displayForWrongMatch} = this.state
    console.log(score)
    const displayScoreCard = time >= 1
    return (
      <>
          ...
          <ul>
            ...
            <li className="timer">
              <img
                ...
                alt="timer"
              />
              <p className="score score-color">{time} sec</p>
            </li>
          </ul>
        </nav>
        <div className="bg-container">
          {!(displayScoreCard && displayForWrongMatch) ? (
            <div className="bg-card">
              ...
              <button onClick={this.resetGame} className="button" type="button">
                <img
            ...
            <GameOn
              ...
              score={score}
              seconds={time}
              updateScoreFunc={this.updateScore}
              updateTimeFunc={this.updateTime}
              updateDisplayFunc={this.updateDisplayMisMatch}
            />
          )}
        </div>
      </>
